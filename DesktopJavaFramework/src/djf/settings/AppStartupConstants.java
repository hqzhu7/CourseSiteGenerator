...
public class AppStartupConstants
{
    ...
    public static final String APP_PROPERTIES_FILE_CHN = "app_properties_chn.xml";
    ...
    public static final String OLD_PATH="./work/SiteSaveTest.json";
    public static final String REP_PATH="../cse308/public_html/js/SiteSaveTest.json";
    public static final String SOURCE_PATH="../cse308/public_html";
