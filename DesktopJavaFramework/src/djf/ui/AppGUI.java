...
public class AppGUI {
    ...
    private void initFileToolbar(AppTemplate app) {
        ...
        seperate.setMinWidth(800);
        fileToolbarPane.getChildren().add(seperate);
        undoButton = initChildButton(fileToolbarPane,	UNDO_ICON.toString(),	    UNDO.toString(),	false);
        redoButton = initChildButton(fileToolbarPane,	REDO_ICON.toString(),	    REDO.toString(),	false);
        aboutButton = initChildButton(fileToolbarPane,	ABOUT_ICON.toString(),	    ABOUT.toString(),	false);
