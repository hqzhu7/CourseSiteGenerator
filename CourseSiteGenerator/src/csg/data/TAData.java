...
public class TAData{
    ...
    ArrayList<TimeSlot> tempTS = new ArrayList();
    ...
    public void resetData() {
        ...
        officeHours.clear();
        Workspace ta = (Workspace) app.getWorkspaceComponent();
        TaTab taTab = (TaTab)ta.getTaTab();
        
       ComboBox a=(ComboBox) taTab.getOfficeHoursSubheaderBox().getChildren().get(2);
       ComboBox c=(ComboBox) taTab.getOfficeHoursSubheaderBox().getChildren().get(4);
   ...
   if(a.validate(initEmail)){
     ...
     public void addTA(String initName, String initEmail,boolean bol) {
        // MAKE THE TA
        EmailValidator a=new EmailValidator();
   if(a.validate(initEmail)){
        TeachingAssistant ta = new TeachingAssistant(initName, initEmail);
    ...
    public void toggleTAOfficeHours(String cellKey, String taName) {
        ...
        //System.out.println(officeHours.get(cellKey));
    ...
    public ArrayList<TimeSlot> getTempTS() {
      return tempTS;  
    }
}